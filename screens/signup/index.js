          ...
          <View style={styles.footerContainer}>
            ...
            <TouchableOpacity>
              <View style={styles.signin}>
                ...
                <Text style={styles.whiteFont} onPress={this.props.goToLogin}> Sign In</Text></Text>
              </View>
            </TouchableOpacity>
          </View>
        </Image>
      ...
      <View style={styles.container}>
        ...
        >
          ...
          <View style={styles.footerContainer}>
                  ...
                  <TouchableOpacity
                  onPress={() => {this.props.goToCamera(this.state.userName, this.state.userEmail, this.state.userPassword)}} 
                  >
                    <View style={styles.signup}>
